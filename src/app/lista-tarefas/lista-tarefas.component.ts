...
import { animateCheckBox, filterTrigger, formButtonTrigger, highlitedStateTrigger, shownStateTrigger } from '../animations';

@Component({
  selector: 'app-lista-tarefas',
  templateUrl: './lista-tarefas.component.html',
  styleUrls: ['./lista-tarefas.component.css'],
  animations: [highlitedStateTrigger, shownStateTrigger, animateCheckBox, filterTrigger, formButtonTrigger]
})
export class ListaTarefasComponent implements OnInit {
  ...
  filtrarTarefasDescricao(descricao: string) {
